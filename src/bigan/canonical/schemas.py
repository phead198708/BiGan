...
SCHEMA_FEATURES_15M_V1: pa.Schema = pa.schema(
    [
        ...
        pa.field("minute_of_day", pa.float64(), nullable=True),
        pa.field("day_of_week", pa.int32(), nullable=True),
        pa.field("underlying_id", pa.float64(), nullable=True),
        pa.field("horizon_minutes", pa.float64(), nullable=True),
        pa.field("liquidity_bucket", pa.float64(), nullable=True),
        pa.field("ret_30m", pa.float64(), nullable=True),
        pa.field("rv_30m", pa.float64(), nullable=True),
        pa.field("aggressor_buy_ratio_1m", pa.float64(), nullable=True),
        pa.field("avg_trade_size_1m", pa.float64(), nullable=True),
        pa.field("tick_spread", pa.float64(), nullable=True),
        pa.field("tick_obi_l1", pa.float64(), nullable=True),
        pa.field("tick_obi_l3", pa.float64(), nullable=True),
        pa.field("tick_mid_price", pa.float64(), nullable=True),
        pa.field("tick_price_velocity", pa.float64(), nullable=True),
        pa.field("tick_trade_arrival_rate", pa.float64(), nullable=True),
    ],
...
# ---------------------------------------------------------------------------
# labels_15m_v1 — independent 15-minute outcome-token profitability labels
# ---------------------------------------------------------------------------
#
...
SCHEMA_LABELS_15M_V1: pa.Schema = pa.schema(
    [
        ...
        pa.field("settlement_margin", pa.float64(), nullable=True),
        pa.field("settlement_abs_margin", pa.float64(), nullable=True),
        pa.field("settlement_neutral_margin", pa.float64(), nullable=True),
        pa.field("label_settlement_3way", pa.string(), nullable=True),
        pa.field("max_exit_gain_up", pa.float64(), nullable=True),
        pa.field("max_exit_gain_down", pa.float64(), nullable=True),
        pa.field("max_exit_return_per_usdc_up", pa.float64(), nullable=True),
        pa.field("max_exit_return_per_usdc_down", pa.float64(), nullable=True),
        pa.field("time_to_best_exit_up", pa.float64(), nullable=True),
        pa.field("time_to_best_exit_down", pa.float64(), nullable=True),
        pa.field("best_exit_price_up", pa.float64(), nullable=True),
        pa.field("best_exit_price_down", pa.float64(), nullable=True),
        pa.field("label_volatility_up", pa.bool_(), nullable=True),
        pa.field("label_volatility_down", pa.bool_(), nullable=True),
        pa.field("volatility_path_validity_up", pa.string(), nullable=True),
        pa.field("volatility_path_validity_down", pa.string(), nullable=True),
        pa.field("label_profit_up_15m", pa.bool_(), nullable=True),
        pa.field("label_profit_down_15m", pa.bool_(), nullable=True),
        pa.field("label_up_15m", pa.bool_(), nullable=False),
        pa.field("label_down_15m", pa.bool_(), nullable=True),
...
SCHEMA_PREDICTIONS: pa.Schema = pa.schema(
    [
        ...
        pa.field("p_up", pa.float64(), nullable=True),
        pa.field("p_down", pa.float64(), nullable=True),
        pa.field("p_neutral", pa.float64(), nullable=True),
        pa.field("p_vol_up", pa.float64(), nullable=True),
        pa.field("p_vol_down", pa.float64(), nullable=True),
        pa.field("settlement_residual", pa.float64(), nullable=True),
        pa.field("token_side", pa.string(), nullable=True),
        pa.field("model_probability", pa.float64(), nullable=True),
        pa.field("polymarket_price", pa.float64(), nullable=True),
        pa.field("mispricing_edge", pa.float64(), nullable=True),
        pa.field("token_expected_win_probability", pa.float64(), nullable=True),
        pa.field("p_up_residual_adjusted", pa.float64(), nullable=True),
        pa.field("p_down_residual_adjusted", pa.float64(), nullable=True),
        pa.field("entry_worst_price_up", pa.float64(), nullable=True),
        pa.field("entry_worst_price_down", pa.float64(), nullable=True),
        pa.field("expected_edge_up", pa.float64(), nullable=True),
        pa.field("expected_edge_down", pa.float64(), nullable=True),
        pa.field("residual_expected_edge_up", pa.float64(), nullable=True),
        pa.field("residual_expected_edge_down", pa.float64(), nullable=True),
        pa.field("p_up_hit_5c_before_loss_10c", pa.float64(), nullable=True),
        pa.field("p_up_hit_10c_before_loss_10c", pa.float64(), nullable=True),
        pa.field("p_up_loss_10c_before_hit_5c", pa.float64(), nullable=True),
        pa.field("p_down_hit_5c_before_loss_10c", pa.float64(), nullable=True),
        pa.field("p_down_hit_10c_before_loss_10c", pa.float64(), nullable=True),
        pa.field("p_down_loss_10c_before_hit_5c", pa.float64(), nullable=True),
        pa.field("selected_hit_5c_before_loss_10c", pa.float64(), nullable=True),
        pa.field("selected_hit_10c_before_loss_10c", pa.float64(), nullable=True),
        pa.field("selected_loss_10c_before_hit_5c", pa.float64(), nullable=True),
        pa.field("selected_confidence_score", pa.float64(), nullable=True),
        pa.field("selected_side", pa.string(), nullable=True),
        pa.field("selected_expected_edge", pa.float64(), nullable=True),
        pa.field("should_enter_settlement", pa.bool_(), nullable=True),
        pa.field("market_implied_prob", pa.float64(), nullable=True),
