#!/usr/bin/env python3
"""Run preregistered historical-development iteration 2 exactly once."""
...
DEFAULT_PREREGISTRATION = (
    CONFIG_DIR
    / "challenge_historical_development_iteration_002_preregistration.json"
)
DEFAULT_MARKET_IDS = (
    CONFIG_DIR / "challenge_historical_development_exact_195_market_ids.txt"
)
DEFAULT_PREVIOUS_ENTRY = (
    CONFIG_DIR / "challenge_historical_development_iteration_001_entry.json"
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if (
        ...
        raise ValueError("iteration-2 preregistration mismatch")
    ...
    # Freeze target-free decisions before reading the outcome comparison.
    _verify(
    ...
    candidate_decisions = materialize_high_price_support_recovery_decisions(
    ...
    target_free_manifest = {
        "schema_version": (
            "bigan-v8-challenge-high-price-support-recovery-"
