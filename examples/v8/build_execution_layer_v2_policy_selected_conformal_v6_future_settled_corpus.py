#!/usr/bin/env python3
"""Build the quarantined post-freeze settled corpus for the #207 v6 future gate."""
...
from bigan.v8.polymarket.training.execution_layer_v2_policy_selected_conformal_net_return_v6_future_settlement import (  # noqa: E402
    PolicySelectedConformalV6FutureSettlementIndexConfig,
    build_policy_selected_conformal_v6_future_settled_corpus_index,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = build_policy_selected_conformal_v6_future_settled_corpus_index(
        PolicySelectedConformalV6FutureSettlementIndexConfig(
            run_id=args.run_id,
        ...
        json.dumps(
            {
                ...
                "settled_corpus_ready_market_count": report[
                    "settled_corpus_ready_market_count"
                ],
                "unresolved_or_failed_market_count": report[
                ...
                "index_path": (
                    None if result["index_path"] is None else str(result["index_path"])
                ),
