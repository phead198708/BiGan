"""Assign frozen #175 90/45/60 roles after outcome-blind execution audit."""
...
def run_role_assignment(
    *,
    ...
    result = assign_pairwise_action_advantage_lcb_roles(
        PairwiseActionAdvantageLCBRoleAssignmentConfig(
            run_id=run_id,
            output_dir=output_dir,
            precollection_freeze_manifest_path=precollection_freeze_manifest,
            expected_precollection_freeze_manifest_sha256=(precollection_freeze_manifest_sha256),
...
def main(argv: list[str] | None = None) -> int:
    ...
    summary = run_role_assignment(
        ...
        precollection_freeze_manifest_sha256=(args.precollection_freeze_manifest_sha256),
