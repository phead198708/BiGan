"""Freeze strict independent-security-review and v6 preapproval artifacts."""
...
from bigan.v8.polymarket.residual_promotion_release_readiness_v6 import (  # noqa: E402
...
CREATED_AT = "2026-08-10T21:25:00Z"
...
def main() -> int:
    ...
    release = freeze_release_readiness_v6(
        repository_root=ROOT,
        created_at=CREATED_AT,
    )
    print(
