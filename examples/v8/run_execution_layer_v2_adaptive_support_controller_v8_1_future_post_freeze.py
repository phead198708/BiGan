#!/usr/bin/env python3
"""Run one explicit #246 settlement or future-PnL evaluation stage."""
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--expected-target-free-freeze-manifest-sha256",
        required=True,
    )
...
def main() -> None:
    ...
    if args.stage == "settle":
        result = build_adaptive_support_controller_v8_1_future_settled_index(
            AdaptiveSupportControllerV81FutureSettlementConfig(
                run_id=args.run_id,
        ...
        result = evaluate_adaptive_support_controller_v8_1_future_pnl_gate(
            AdaptiveSupportControllerV81FutureEvaluationConfig(
                run_id=args.run_id,
                output_dir=args.output_dir,
                target_free_freeze_manifest_path=(
