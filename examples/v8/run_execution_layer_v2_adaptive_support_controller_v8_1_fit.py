#!/usr/bin/env python3
"""Run the preregistered issue #245 historical adaptive support gate."""
...
from bigan.v8.polymarket.training.execution_layer_v2_adaptive_support_controller_v8_1 import (
    AdaptiveSupportControllerV81Config,
    run_adaptive_support_controller_v8_1_fit,
)
...
def main() -> int:
    ...
    result = run_adaptive_support_controller_v8_1_fit(
        AdaptiveSupportControllerV81Config(
            run_id=args.run_id,
