"""Assign frozen #173 60/30/30 roles after outcome-blind execution audit."""
...
from bigan.v8.polymarket.training.execution_layer_v2_execution_compatible_mean_lcb import (  # noqa: E402
    ExecutionCompatibleMeanLCBRoleAssignmentConfig,
    assign_execution_compatible_mean_lcb_roles,
)
...
def run_role_assignment(
    *,
    ...
    result = assign_execution_compatible_mean_lcb_roles(
        ExecutionCompatibleMeanLCBRoleAssignmentConfig(
            run_id=run_id,
