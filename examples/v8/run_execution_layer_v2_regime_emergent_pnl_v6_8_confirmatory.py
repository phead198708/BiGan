"""Run #229 v6.8 confirmatory settlement or execution-PnL evaluation."""
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--stage", required=True, choices=("settle", "evaluate_confirmatory"))
    ...
    parser.add_argument("--expected-prediction-freeze-manifest-sha256", required=True)
...
def main() -> None:
    ...
    result = run_v6_8_confirmatory_post_freeze(
        V68ConfirmatoryPostFreezeConfig(
            stage=args.stage,
            run_id=args.run_id,
            ...
            expected_runtime_policy_profile_sha256=(args.expected_runtime_policy_profile_sha256),
            settled_corpus_index_path=args.settled_corpus_index,
            expected_settled_corpus_index_sha256=(args.expected_settled_corpus_index_sha256),
