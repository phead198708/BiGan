#!/usr/bin/env python3
"""Run the frozen issue #240 v7.7 outcome-blind target-free canary."""
...
from bigan.v8.polymarket.training.execution_layer_v2_rolling_origin_drift_adaptive_action_value_v7_7_canary import (
    RollingOriginDriftAdaptiveV77CanaryConfig,
    run_rolling_origin_drift_adaptive_v7_7_target_free_canary,
)
...
def main() -> None:
    ...
    result = run_rolling_origin_drift_adaptive_v7_7_target_free_canary(
        RollingOriginDriftAdaptiveV77CanaryConfig(
            run_id=args.run_id,
