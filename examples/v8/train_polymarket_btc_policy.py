...
def run_polymarket_policy_training_cli(
    *,
    ...
    return {
        ...
        "action_value_model_family": result.model_manifest["action_value_model_family"],
        "feature_conditioned_action_value_model_enabled": result.model_manifest[
        ...
        "calibration_split": result.model_manifest["calibration_split"],
        "replay_split": result.model_manifest["replay_split"],
        "out_of_sample_replay": result.model_manifest["out_of_sample_replay"],
