#!/usr/bin/env python3
"""Run the preregistered issue #243 historical score-rank gate."""
...
from bigan.v8.polymarket.training.execution_layer_v2_rolling_origin_score_rank_abstention_v7_9 import (
    RollingOriginScoreRankAbstentionV79Config,
    run_rolling_origin_score_rank_abstention_v7_9_fit,
)
...
def main() -> int:
    ...
    result = run_rolling_origin_score_rank_abstention_v7_9_fit(
        RollingOriginScoreRankAbstentionV79Config(
            run_id=args.run_id,
