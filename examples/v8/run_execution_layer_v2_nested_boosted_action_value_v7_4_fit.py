#!/usr/bin/env python3
"""Fit and replay the issue #236 nested boosted v7.4 candidate."""
...
from bigan.v8.polymarket.training.execution_layer_v2_nested_boosted_action_value_v7_4 import (
    ...
    run_nested_boosted_action_value_v7_4_fit,
)
...
def main() -> int:
    ...
    result = run_nested_boosted_action_value_v7_4_fit(
        NestedBoostedActionValueV74Config(
            run_id=args.run_id,
        ...
        json.dumps(
            {
                ...
                "model_improvement_demonstrated": model[
