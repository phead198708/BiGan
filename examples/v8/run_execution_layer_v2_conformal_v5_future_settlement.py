"""Reconcile frozen #204 decisions with post-close targets and run side-only gates."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = reconcile_conformal_v5_future_settlement(
        ConformalV5FutureSettlementConfig(
            run_id=args.run_id,
        ...
        json.dumps(
            {
                ...
                "guard_accepted_unique_market_count": gate["guard_accepted_unique_market_count"],
                "accepted_side_metrics": gate["accepted_side_metrics"],
                "candidate_post_cost_net_pnl": gate["candidate_post_cost_net_pnl"],
                "matched_baseline_post_cost_net_pnl": gate["matched_baseline_post_cost_net_pnl"],
