"""Run or verify the preregistered BTC 15m market-anchored residual v2 OOF gate."""
...
from bigan.v8.polymarket.cost_aware_residual_v2 import (  # noqa: E402
    DEFAULT_OUTPUT_DIR,
    DEFAULT_PROTOCOL,
...
def main() -> int:
    ...
    if args.mode == "run":
        ...
        result = run_residual_v2_rolling_origin_oof(
        ...
        result = verify_frozen_residual_v2_oof(
            protocol_path=args.protocol,
            output_dir=args.output_dir,
            repository_root=ROOT,
        )
