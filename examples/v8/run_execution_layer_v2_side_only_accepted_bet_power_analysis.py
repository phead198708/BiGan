"""Run the frozen #205 prospective side-only accepted-bet power analysis."""
...
from bigan.v8.polymarket.training.execution_layer_v2_side_only_accepted_bet_power import (  # noqa: E402
