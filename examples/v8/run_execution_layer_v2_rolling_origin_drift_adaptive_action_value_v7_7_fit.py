#!/usr/bin/env python3
"""Run the preregistered issue #240 rolling-origin historical replay."""
...
from bigan.v8.polymarket.training.execution_layer_v2_rolling_origin_drift_adaptive_action_value_v7_7 import (
    RollingOriginDriftAdaptiveV77Config,
    run_rolling_origin_drift_adaptive_v7_7_fit,
)
...
def main() -> int:
    ...
    result = run_rolling_origin_drift_adaptive_v7_7_fit(
        RollingOriginDriftAdaptiveV77Config(
            run_id=args.run_id,
            ...
            consumed_stream_five_action_rows_path=args.consumed_stream_five_action_rows,
