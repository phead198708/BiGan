#!/usr/bin/env python3
"""Run the preregistered issue #244 historical support-budgeted rank gate."""
...
from bigan.v8.polymarket.training.execution_layer_v2_rolling_origin_support_budgeted_score_rank_v8_0 import (
    RollingOriginSupportBudgetedScoreRankV80Config,
    run_rolling_origin_support_budgeted_score_rank_v8_0_fit,
)
...
def main() -> int:
    ...
    result = run_rolling_origin_support_budgeted_score_rank_v8_0_fit(
        RollingOriginSupportBudgetedScoreRankV80Config(
            run_id=args.run_id,
