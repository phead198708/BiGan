"""Run or verify the preregistered BTC 15m residual quantile challenger."""
...
from bigan.v8.polymarket.cost_aware_residual_quantile import (  # noqa: E402
...
def main() -> int:
    ...
    if args.mode == "run":
        ...
        result = run_quantile_challenger_oof(
